  ...
  const contactMethods = [
    {
      ...
      details: "support@centsify.com",
      action: "mailto:support@centsify.com",
    },
    {
      icon: (
        <svg
...
const faqs = [
  {
    question: "Is my financial data secure on Centsify?",
    answer:
      "Yes. Centsify uses advanced encryption (AES-256) and secure HTTPS connections to protect your data. All personal and financial details are encrypted both in transit and at rest. We never share or sell your data to anyone.",
  },
  {
    question: "Can I scan and upload receipts using Centsify?",
    answer:
      "Absolutely! Centsify integrates Google Gemini AI for OCR-based receipt scanning. Just upload a photo of your receipt, and the app automatically extracts merchant name, amount, and date, then categorizes it as a transaction.",
  },
  {
    question: "Do I need to pay to use Centsify?",
    answer:
      "No. Centsify is completely free to use for personal finance tracking. In future, we may introduce optional premium features like multi-account analytics or AI-based financial insights.",
  },
  {
    question: "Can I access my account from multiple devices?",
    answer:
      "Yes. Centsify is a web-based app, so you can securely log in from any device—desktop, tablet, or mobile browser. Your data stays synced across all devices automatically.",
  },
  {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen font-montserrat text-gray-800 dark:text-gray-200">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-white/20">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <p className="text-blue-100">
                    ...
                    <a
                      href="mailto:support@centsify.com"
      ...
      <footer className="py-8 text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800">
        <p>&copy; {new Date().getFullYear()} Centsify. All Rights Reserved.</p>
      </footer>
    </div>
  );
};
